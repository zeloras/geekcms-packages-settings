                        ...
                        <form action="{{ route('admin.setting.variables.save') }}" method="POST">
                            ...
                            <table class="table table-bordered table-custom table-hover settings-container">
                                ...
                                <tr id="configRow0" class="settings-container__line">
                                    <td></td>
                                    <td>
                                        <input data-key="key" name="configs[key][]" type="text" class="form-control"
                                               placeholder="{{Translate::get('module_setting::admin/main.key')}}">
                                    </td>
                                    <td>
                                        <input data-key="value" type="text" name="configs[value][]" class="form-control"
                                               placeholder="{{Translate::get('module_setting::admin/main.value')}}">
                                    </td>
                                    <td class="table-icon-cell">
                                        <button type="button" class="btn btn-primary settings-container-remove"
                                                title="{{Translate::get('module_setting::admin/main.remove_variable')}}">
                                            <i class="fa fa-minus-circle"></i>
                                        </button>
                                        <button data-key="create" type="button"
                                                class="btn btn-success settings-container-add"
                                                title="{{Translate::get('module_setting::admin/main.create_variable')}}">
